...
/obj/machinery/vending/cards
	...
	create_products()
		...
		product_list += new/datum/data/vending_product(/obj/item/boardgame/go, 1, cost=PAY_TRADESMAN/2)
		product_list += new/datum/data/vending_product(/obj/item/boardgame/xiangqi, 1, cost=PAY_TRADESMAN/2)
