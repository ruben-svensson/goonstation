...
export const GasCanister = (props, context) => {
  ...
  return (
    <Window width={hasDetonator ? (hasPaper ? 880 : 470) : 305} height={hasDetonator ? 685 : 340}>
      <Window.Content>
        <Flex>
          <Flex.Item width="480px">
            <PortableBasicInfo connected={connected} pressure={pressure} maxPressure={maxPressure}>
              <Divider />
              {hasValve ? (
                <ReleaseValve
            ...
            {detonator ? (
              ...
              <PortableHoldingTank holding={holding} onEjectTank={handleEjectTank} />
            )}
          </Flex.Item>
          {!!hasPaper && (
